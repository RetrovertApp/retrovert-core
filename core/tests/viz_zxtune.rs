...
// only after an explicit scope_enable (no hidden auto-on).
...
fn zxtune_viz_vtable() {
    ...
    assert!(plugin.viz_info.is_some(), "zxtune must implement viz_info");
    assert!(plugin.scope_channels.is_some(), "zxtune must implement scope_channels");
    assert!(plugin.scope_enable.is_some(), "zxtune must implement scope_enable");
    assert!(plugin.scope_samples.is_some(), "zxtune must implement scope_samples");
